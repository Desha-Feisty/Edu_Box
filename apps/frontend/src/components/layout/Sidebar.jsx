        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        {/* ── Logo Section ────────────────────────────── */}
                        <div className="h-20 flex items-center justify-center border-b border-slate-200/50 dark:border-white/[0.04]">
                            <div
                        ...
                        <nav className="flex-1 p-4 flex flex-col gap-0.5 overflow-y-auto">
                            {links.map((link) => (
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        [
                                            "flex items-center gap-3.5 px-4 py-2.5 rounded-xl text-sm font-semibold",
                                            ...
                                            isActive
                                                ...
                                                : "text-slate-500 dark:text-slate-400 hover:bg-white/60 dark:hover:bg-slate-800/30 hover:text-slate-700 dark:hover:text-slate-200",
                                        ].join(" ")
                                    }
                                >
                        ...
                        <div className="p-4 border-t border-slate-200/50 dark:border-white/[0.04] bg-gradient-to-t from-brand-700/[0.04] to-transparent">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3.5 px-4 py-3 rounded-xl text-white bg-gradient-to-r from-red-500 to-rose-600 font-semibold text-sm shadow-lg shadow-red-500/25 cursor-pointer hover:shadow-xl hover:shadow-red-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 border-none"
                            >
